...
export function FacultySidebar() {
  ...
  useEffect(() => {
    ...
    if (storedFaculty) {
      ...
      // Ensure this is a faculty user, not HOD
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-sidebar border-b border-sidebar-border z-50 flex items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-sidebar-foreground">Faculty Portal</span>
        </div>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center gap-3 px-4 border-b border-sidebar-border">
            ...
            <div>
              <h1 className="font-bold text-sidebar-foreground">Faculty Portal</h1>
          ...
          <div className="p-4 border-t border-sidebar-border space-y-3">
            <div className="flex items-center gap-3 px-3 py-2 bg-sidebar-accent/30 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-sidebar-foreground truncate">{faculty.name}</p>
                <p className="text-xs text-sidebar-foreground/60 truncate">{faculty.department}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <ThemeToggle />
